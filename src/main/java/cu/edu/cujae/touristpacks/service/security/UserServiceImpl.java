...
public class UserServiceImpl implements UserService {
	...
	public List<UserDto> getUsers() {
		...
		users.add(new UserDto(UUID.randomUUID().toString().replaceAll("-", "").substring(0, 9), "imeriño", "Ian Meriño Sandival", "4weer4ewere", "imeri�o@email.com", "21254789632", allRoles, false));
